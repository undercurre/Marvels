<template>
	<div class="clock">
		<flip-item :total="formatTime(deadline).day" :current="formatTime(remainingTime).day" />
		<flip-item :total="formatTime(deadline).hour" :current="formatTime(remainingTime).hour" />
		<flip-item :total="formatTime(deadline).minute" :current="formatTime(remainingTime).minute" />
		<flip-item :total="formatTime(deadline).second" :current="formatTime(remainingTime).second" />
	</div>
</template>
